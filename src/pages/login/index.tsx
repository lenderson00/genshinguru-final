...
// lg:bg-gray-700  lg:bg-gradient-to-br lg:from-transparent lg:to-gray-900
  return (
    ...
    >
      ...
      <div  className="max-w-5xl w-full relative mx-auto py-10 lg:px-8 space-y-4 bg-white  lg:h-max lg:rounded-xl lg:shadow-2xl ">
        <div className="relative max-w-96 w-full p-5  flex flex-col lg:flex-row gap-2">
          ...
          <div className="absolute max-w-xl -right-52 top-36 hidden lg:block">
