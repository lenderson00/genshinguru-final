...
export const DashboardHeader = () => {
    ...
    return (
        <div className="absolute top-4 w-full flex justify-end pr-24 ">
          <div className="w-14 h-14 bg-slate-300 rounded-full relative cursor-pointer" onClick={() => SetIsOpen(!isOpen)} >
            <Image src={Avatar} alt={'avatar buttom'} />
